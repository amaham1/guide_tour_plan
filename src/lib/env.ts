...
export const appEnv = {
  ...
  osrmFootBaseUrl: env("OSRM_FOOT_BASE_URL", env("OSRM_BASE_URL", "http://localhost:5000")),
  osrmBusDistanceBaseUrl: env("OSRM_BUS_DISTANCE_BASE_URL", "http://localhost:5001"),
  osrmBusEtaBaseUrl: env("OSRM_BUS_ETA_BASE_URL", "http://localhost:5002"),
  osrmBusEtaDatasetName: env("OSRM_BUS_ETA_DATASET_NAME", "bus-eta"),
  osrmBaseUrl: env("OSRM_FOOT_BASE_URL", env("OSRM_BASE_URL", "http://localhost:5000")),
  gtfsFeedUrl: env("GTFS_FEED_URL"),
  gtfsShapesPath: env("GTFS_SHAPES_PATH"),
  busOsrmVehicleHeight: Number(env("BUS_OSRM_VEHICLE_HEIGHT", "3.6")),
  busOsrmVehicleWidth: Number(env("BUS_OSRM_VEHICLE_WIDTH", "2.5")),
  busOsrmVehicleLength: Number(env("BUS_OSRM_VEHICLE_LENGTH", "11.0")),
  busOsrmVehicleWeight: Number(env("BUS_OSRM_VEHICLE_WEIGHT", "14000")),
